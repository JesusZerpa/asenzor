// Transcrypt'ed from Python, 2021-08-10 14:58:26
var re = {};
...
export var Media =  __class__ ('Media', [VuePy], {
	...
	get accept () {return __get__ (this, async function (self) {
		...
		var modal = M.getinstance (document.querySelector ('#media_modal'));
		modal.close ();
		await self.off ();
	});}
});

//# sourceMappingURL=components.media.map