...
export var VuePy =  __class__ ('VuePy', [object], {
	...
	get deploy () {return __get__ (this, function (self) {
	...
	get mount () {return __get__ (this, function (self, el) {
		self.deploy ();
		self.vue ['$mount'] (el);
		return self;
	});},
...
//# sourceMappingURL=asenzor.py.vuepy.map