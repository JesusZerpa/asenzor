// Transcrypt'ed from Python, 2021-01-17 05:38:28
...
export var Edit =  __class__ ('Edit', [VuePy], {
	...
	get data () {return __get__ (this, function (self) {
		return dict ({'content': (window.DATA ['post'] ? window.DATA ['post'] ['content'] : ''), 'title': (window.DATA ['post'] ? window.DATA ['post'] ['title'] : ''), 'status': null, 'author': null, 'order': null, 'type': null, 'template': null, 'main_image': null, 'toogle': self.toogle, 'post_type': null, 'type': 'post'});
	});},
	...
	get update_from_widget () {return __get__ (this, function (self, evt) {
